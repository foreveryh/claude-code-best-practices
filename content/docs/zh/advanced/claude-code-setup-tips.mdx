...
category: "advanced"
language: "zh"
tags: ["claude-code", "ai-编程", "生产力", "自动化", "mcp", "技巧"]
---
...
[Claude Code 钩子](https://docs.anthropic.com/en/docs/claude-code/hooks)是 Claude 自动化的秘密武器。它们是在 Claude Code 工作流程特定点自动执行的*确定性*命令，为大量自动化打开了大门。
