...
language: "zh"
tags: ["ai开发", "自动化", "claude-code", "copilot", "cicd", "架构设计"]
---
...
**🔗 相关最佳实践：** [复合工程 - 信任流程，验证输出](/docs/zh/best-practices/compounding-engineering-framework#principle-5-trust-process-verify-output)
...
**🔗 相关最佳实践：** [CCPM 子代理专业化](/docs/zh/advanced/ccpm-claude-code-project-manager#sub-agent-specialization)
...
**🔗 相关最佳实践：** [保持上下文精简但个性化](/docs/zh/best-practices/compounding-engineering-framework#principle-4-context-lean)
...
**🔗 相关最佳实践：** [知识编码工作流](/docs/zh/best-practices/compounding-engineering-framework#knowledge-codification)
...
**🔗 相关最佳实践：** [自定义命令系统](/docs/zh/best-practices/compounding-engineering-framework#custom-command-system)
...
**🔗 相关最佳实践：** [并行执行挑战](/docs/zh/best-practices/compounding-engineering-framework#parallel-execution-challenges)
...
**🔗 相关最佳实践：** [人机协作协议](/docs/zh/advanced/ccpm-claude-code-project-manager#human-ai-collaboration-protocol)
...
**🔗 相关最佳实践：** [提示工程架构](/docs/zh/advanced/claude-code-analysis#prompt-engineering)
...
**🔗 相关最佳实践：** [子代理专业化](/docs/zh/advanced/ccpm-claude-code-project-manager#sub-agent-specialization)
...
- **[复合工程框架](/docs/zh/best-practices/compounding-engineering-framework)** - AI-人类协作的核心原则
- **[CCPM Claude Code 项目管理器](/docs/zh/advanced/ccpm-claude-code-project-manager)** - 与 AI 代理的高级项目管理
- **[Claude Code 分析](/docs/zh/advanced/claude-code-analysis)** - AI 工具架构深度解析
- **[子代理集合](/docs/zh/sub-agents/sub-agents-collections)** - 专业化 AI 代理实现

⸻

## 关键要点

1. **质量门禁不可妥协** - AI 生成的代码必须通过与人工编写代码相同的标准
2. **架构成就 AI** - 模块化、文档完善的系统让 AI 能够有效工作
3. **流程胜过工具** - 系统化方法比特定 AI 模型更重要
4. **上下文为王** - 分层提示系统引导 AI 产生一致、高质量的输出
5. **迭代驱动改进** - 每次失败都成为整个系统的学习机会
